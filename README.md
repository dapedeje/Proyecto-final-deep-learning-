...
| Nosotros           | Transfer learning                                                                                   | ResNet50 + capa *Dense*                                                                                                                                        |           24,126,901 |             63.4 % |      0.011 |      1.752 |     2.095 |
| Nosotros           | ResNet50 + capa Dense                                                                               | Usando la arquitectura del modelo de transfer learning entrenamos sin congelar capas                                                                           |           24,126,901 |             94.7 % |       0.013 |      0.221 |     0.599 |
